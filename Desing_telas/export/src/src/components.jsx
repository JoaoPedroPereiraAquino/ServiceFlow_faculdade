...
// ─── AppLogo ───────────────────────────────────────────────
function AppLogo({ theme, size = 56, withText = true, align = 'center' }) {
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* SF monogram using overlapping shapes */}
        <svg viewBox="0 0 40 40" width={size * 0.6} height={size * 0.6}>
          <path d="M10 8 Q 8 8 8 10 L 8 20 Q 8 22 10 22 L 20 22 Q 22 22 22 24 L 22 30 Q 22 32 20 32 L 10 32" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"/>
          <path d="M26 8 L 26 32 M 26 8 L 34 8 M 26 19 L 32 19" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"/>
        </svg>
      </div>
      {withText && (
        <div style={{ textAlign: align === 'center' ? 'center' : 'left' }}>
          <div style={{
            ...
            Service<span style={{ color: theme.primary }}>Flow</span>
          </div>
          {align === 'center' && (
